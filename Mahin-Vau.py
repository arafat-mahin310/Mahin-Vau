...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Arafat Bin Mahin 
\033[1;91m GitHub      : https://github.com/arafat-mahin310
\033[1;91m YouTube     : Termux Master
\033[1;91m Telegram    : CommiNg 🔜
\033[1;91m Blogspot    : loading.....
\033[1;97m--------------------------------------------------
"""
...
def dump_username():
    print("%s [%s•%s] %sEXAMPLE : %arafatmahin310"%(H,P,H,K,H));_query_ = _cici_azimvau_("%s [%s•%s] %sENTER NAME : "%(H,P,H,K)).lower()
